...
VALUES ('00000000-0000-4000-8000-0000000000bb', 'personal', 'navigation',
         '{"width":"270","collapsedWidth":"68","density":"cozy","showSubtitles":true,"showSectionIcons":true,"showSectionDots":true,"showFooterUser":true,"favorites":[],"hiddenSections":[],"topHeight":"56","topOpacity":"75","topBlur":"xl","showBreadcrumbs":true,"showSearch":true,"showDemoBadge":true,"showNotifications":true,"showThemeToggle":true,"syncWithSidebar":true}'::jsonb)
...
UPDATE admin_settings SET data = jsonb_set(data, '{topHeight}', '"56"', true)
WHERE scope = 'personal' AND category = 'navigation' AND COALESCE(data->>'topHeight','') = '64';
